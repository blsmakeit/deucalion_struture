#!/usr/bin/env python3
"""
Script de simulação — Projeto: PROJECT_NAME
...
def main():
    ...
    save_results(results, PROJECT_NAME, filename=filename)
    ...
    print(f"  scp -r deucalion:{paths['results']}/ ./resultados_{PROJECT_NAME}/")
